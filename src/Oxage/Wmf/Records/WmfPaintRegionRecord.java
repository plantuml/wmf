...
//ORIGINAL LINE: [WmfRecord(Type = RecordType.META_PAINTREGION, Size = 4)] public class WmfPaintRegionRecord : WmfBinaryRecord
public class WmfPaintRegionRecord extends WmfBinaryRecord
{
	public WmfPaintRegionRecord()
	{
		super();
	}
