...
//ORIGINAL LINE: [WmfRecord(Type = RecordType.META_POLYGON, SizeIsVariable = true)] public class WmfPolygonRecord : WmfBinaryRecord
public class WmfPolygonRecord extends WmfBinaryRecord
{
	public WmfPolygonRecord()
	{
		super();
