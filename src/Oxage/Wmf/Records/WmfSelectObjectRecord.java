...
//ORIGINAL LINE: [WmfRecord(Type = RecordType.META_SELECTOBJECT, Size = 4)] public class WmfSelectObjectRecord : WmfBinaryRecord
public class WmfSelectObjectRecord extends WmfBinaryRecord
{
	public WmfSelectObjectRecord()
	{
		super();
	}
