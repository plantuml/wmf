...
//ORIGINAL LINE: [WmfRecord(Type = RecordType.META_CHORD, Size = 11)] public class WmfChordRecord : WmfBinaryRecord
public class WmfChordRecord extends WmfBinaryRecord
{
	public WmfChordRecord()
	{
		super();
	}
	...
	public final void SetChord(Rectangle rectangle, Point firstRadial, Point secondRadial)
	{
