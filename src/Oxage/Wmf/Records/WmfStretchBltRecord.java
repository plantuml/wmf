...
//ORIGINAL LINE: [WmfRecord(Type = RecordType.META_STRETCHBLT, SizeIsVariable = true)] public class WmfStretchBltRecord : WmfBinaryRecord
public class WmfStretchBltRecord extends WmfBinaryRecord
{
	public WmfStretchBltRecord()
	{
		super();
	}
	...
	public final Bitmap16 getTarget()
	{
		return Target;
	}
	public final void setTarget(Bitmap16 value)
	{
		Target = value;
	}
	...
	public void Read(BinaryReader reader)
	{
		...
		if (!isWithoutBitmap)
		{
			this.setTarget(Oxage.Wmf.BinaryReaderExtensions.<Bitmap16>ReadWmfObject(reader));
		}
	}
