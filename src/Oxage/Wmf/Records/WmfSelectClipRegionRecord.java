...
//ORIGINAL LINE: [WmfRecord(Type = RecordType.META_SELECTCLIPREGION, Size = 4)] public class WmfSelectClipRegionRecord : WmfBinaryRecord
public class WmfSelectClipRegionRecord extends WmfBinaryRecord
{
