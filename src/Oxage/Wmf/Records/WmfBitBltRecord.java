...
//ORIGINAL LINE: [WmfRecord(Type = RecordType.META_BITBLT, SizeIsVariable = true)] public class WmfBitBltRecord : WmfBinaryRecord
public class WmfBitBltRecord extends WmfBinaryRecord
{
	public WmfBitBltRecord()
	{
		super();
	}
