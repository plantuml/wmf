...
public enum MetafileEscapes
{
	...
	private static java.util.HashMap<Integer, MetafileEscapes> mappings;
	private static java.util.HashMap<Integer, MetafileEscapes> getMappings()
	{
		if (mappings == null)
		{
			synchronized (MetafileEscapes.class)
			{
				if (mappings == null)
				{
					mappings = new java.util.HashMap<Integer, MetafileEscapes>();
				}
			}
		}
		return mappings;
	...
	private MetafileEscapes(int value)
	{
		intValue = value;
	...
	public static MetafileEscapes forValue(int value)
	{
